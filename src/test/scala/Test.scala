...
class Test extends FunSuite with BeforeAndAfter {
  ...
  properties.put("url", "jdbc:postgresql://postgres-test:5432/kosh")
  ...
  runTests(fileDF("data/us-election-2012-results-by-county.csv"), tableDf("test_table", Map("driver" -> "org.postgresql.Driver", "user" -> "postgres_user", "password" -> "mysecretpassword", "url" -> "jdbc:postgresql://postgres-test:5432/kosh")), "csvtopostgrestest")
